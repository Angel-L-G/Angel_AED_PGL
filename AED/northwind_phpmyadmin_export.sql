...
--
-- Servidor: localhost
-- Tiempo de generación: 24-11-2021 a las 12:54:12
...
CREATE TABLE `products` (
  ...
  `UnitsInStock` smallint UNSIGNED NOT NULL DEFAULT '0',
  `UnitsOnOrder` smallint UNSIGNED NOT NULL DEFAULT '0',
  `ReorderLevel` smallint UNSIGNED NOT NULL DEFAULT '0',
...
--
ALTER TABLE `categories`
  MODIFY `CategoryID` tinyint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `employees`
--
ALTER TABLE `employees`
  MODIFY `EmployeeID` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `orders`
--
ALTER TABLE `orders`
  MODIFY `OrderID` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11078;

--
-- AUTO_INCREMENT de la tabla `order_details`
--
ALTER TABLE `order_details`
  MODIFY `ID` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2156;

--
-- AUTO_INCREMENT de la tabla `products`
--
ALTER TABLE `products`
  MODIFY `ProductID` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;

--
-- AUTO_INCREMENT de la tabla `shippers`
--
ALTER TABLE `shippers`
  MODIFY `ShipperID` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `suppliers`
--
ALTER TABLE `suppliers`
  MODIFY `SupplierID` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
